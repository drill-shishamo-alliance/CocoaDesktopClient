...
import { CauseOfFeelingType } from '../../states/CauseOfFeelingState';
import AmountOfWorkIcon from '../../assets/InputCauseOfFeeling/amountOfWorkIcon.svg';
import AmountOfWorkClickedIcon from '../../assets/InputCauseOfFeeling/FlatOrange/amountOfWorkIcon.svg';
...
const CauseOfFeelingButton = (props: CauseOfFeelingButtonProps) => {
  ...
  const getCauseOfFeelingButtonProps = (causeOfFeeling: CauseOfFeelingType) => {
    switch (causeOfFeeling) {
      case CauseOfFeelingType.AMOUNT_OF_WORK:
        return {
          ariaLabel: 'amount-of-work-button',
          IconComponent: <img src={AmountOfWorkIcon} className={classes.icon} />,
          ClickedIconComponent: <img src={AmountOfWorkClickedIcon} className={classes.icon} />,
        };
      case CauseOfFeelingType.JOB_DESCRIPTION:
        return {
          ariaLabel: 'job-description-button',
          IconComponent: <img src={JobDescriptionIcon} className={classes.icon} />,
          ClickedIconComponent: <img src={JobDescriptionClickedIcon} className={classes.icon} />,
        };
      case CauseOfFeelingType.HUMAN_RELATION:
        return {
          ariaLabel: 'human-relation-button',
          IconComponent: <img src={HumanRelationIcon} className={classes.icon} />,
          ClickedIconComponent: <img src={HumanRelationClickedIcon} className={classes.icon} />,
        };
      case CauseOfFeelingType.EVALUATION:
        return {
          ariaLabel: 'evaluation-button',
          IconComponent: (
            <EvaluationIcon className={classnames(classes.icon, classes.defaultIconColor)} />
          ),
          ClickedIconComponent: (
            <EvaluationIcon className={classnames(classes.icon, classes.clickedIconColor)} />
          ),
        };
      case CauseOfFeelingType.OVERTIME_WORK:
        return {
          ariaLabel: 'overtime-work-button',
          IconComponent: <img src={OvertimeWorkIcon} className={classes.icon} />,
          ClickedIconComponent: <img src={OvertimeWorkClickedIcon} className={classes.icon} />,
        };
      case CauseOfFeelingType.HOLIDAY_WORK:
        return {
          ariaLabel: 'holiday-work-button',
          IconComponent: <img src={HolidayWorkIcon} className={classes.icon} />,
          ClickedIconComponent: <img src={HolidayWorkClickedIcon} className={classes.icon} />,
        };
    }
  };

  const causeOfFeelingButtonProps = getCauseOfFeelingButtonProps(causeOfFeelingType);
  ...
  const causeOfFeelingTextProps = getCauseOfFeelingTextProps(causeOfFeelingType);
        ...
        <FormControlLabel
          ...
          control={
            <Checkbox
              ...
              checkedIcon={causeOfFeelingButtonProps.ClickedIconComponent}
            />
          }
          label=''
        />
