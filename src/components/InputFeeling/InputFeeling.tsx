    ...
    return (
      <div className={classes.root}>
        ...
        <div className={classes.buttons} aria-label='buttons'>
          <FeelingButton feelingType={FeelingType.VERY_SATISFIED} handleClick={this.handleClick} />
          <FeelingButton feelingType={FeelingType.SATISFIED} handleClick={this.handleClick} />
          <FeelingButton feelingType={FeelingType.NORMAL} handleClick={this.handleClick} />
          <FeelingButton feelingType={FeelingType.DISSATISFIED} handleClick={this.handleClick} />
          <FeelingButton
