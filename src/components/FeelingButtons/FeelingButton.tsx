...
const FeelingButton = (props: FeelingButtonProps) => {
    ...
    switch (feeling) {
        ...
        return {
          ...
          IconComponent: (
            <VeryDissatisfiedIcon
              className={classNames(classes.icon, classes.veryDissatisfiedColor)}
            />
          ),
        };
      case FeelingType.DISSATISFIED:
        return {
          ...
          IconComponent: (
            <DissatisfiedIcon className={classNames(classes.icon, classes.dissatisfiedColor)} />
          ),
        };
      case FeelingType.NORMAL:
        return {
          ariaLabel: 'normal-button',
          IconComponent: <FaceIcon className={classNames(classes.icon, classes.normalColor)} />,
        };
      case FeelingType.SATISFIED:
        return {
          ariaLabel: 'satisfied-button',
          IconComponent: (
            <SatisfiedIcon className={classNames(classes.icon, classes.satisfiedColor)} />
          ),
        };
      case FeelingType.VERY_SATISFIED:
        return {
          ...
          IconComponent: (
            <VerySatisfiedIcon className={classNames(classes.icon, classes.verySatisfiedColor)} />
          ),
        };
    }
  };
  ...
  return (
    <div className={classes.buttonContainer}>
      ...
      <Typography
        variant='button'
        className={classNames(classes.detailText, typographyProps.colorClassName)}
